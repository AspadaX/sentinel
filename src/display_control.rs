...
pub fn format_message(level: Level, message: String) -> String {
    let indentation: String = ">> ".to_string();

    match level {
        Level::Logging => format!("{}{}", indentation, style(message).green()),
        Level::Error => format!("{}{}", indentation, style(message).red().bold()),
        Level::Warn => format!("{}{}", indentation, style(message).red()),
        Level::Selection => format!("{}{}", indentation, style(message).blue()),
        Level::Input => format!("{}{} ", indentation, style(message).blue()),
    }
}
